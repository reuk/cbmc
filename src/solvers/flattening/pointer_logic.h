...
public:
  ...
  std::size_t get_null_object() const { return null_object; }

  // number of INVALID object
  std::size_t get_invalid_object() const { return invalid_object; }
...
protected:
  ...
  exprt object_rec(const mp_integer &offset, const typet &pointer_type,
