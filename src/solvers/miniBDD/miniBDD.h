...
public:
  ...
  mini_bdd_nodet(class mini_bdd_mgrt *_mgr, unsigned _var,
                 unsigned _node_number, const mini_bddt &_low,
...
public:
  ...
  void DumpTikZ(std::ostream &out, bool supress_zero = false,
...
mini_bddt substitute(const mini_bddt &where, unsigned var,
