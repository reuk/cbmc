...
void dplib_propt::land(literalt a, literalt b, literalt o) {
  out << "// land" << std::endl;
  out << "AXIOM (" << dplib_literal(a) << " & " << dplib_literal(b) << ") <=> "
      << dplib_literal(o) << ";" << std::endl
      << std::endl;
}
...
literalt dplib_propt::land(literalt a, literalt b) {
  ...
  out << dplib_literal(a) << " & " << dplib_literal(b) << ";" << std::endl
      << std::endl;
...
literalt dplib_propt::lnand(literalt a, literalt b) { return !land(a, b); }
...
literalt dplib_propt::lnor(literalt a, literalt b) { return !lor(a, b); }
...
literalt dplib_propt::limplies(literalt a, literalt b) { return lor(!a, b); }
...
literalt dplib_propt::lselect(literalt a, literalt b, literalt c) {
  ...
  out << "IF " << dplib_literal(a) << " THEN " << dplib_literal(b) << " ELSE "
      << dplib_literal(c) << " ENDIF;" << std::endl
      << std::endl;
