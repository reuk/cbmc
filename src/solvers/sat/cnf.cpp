...
literalt cnft::lnand(literalt a, literalt b) { return !land(a, b); }
...
literalt cnft::lnor(literalt a, literalt b) { return !lor(a, b); }
...
literalt cnft::lequal(literalt a, literalt b) { return !lxor(a, b); }
...
literalt cnft::limplies(literalt a, literalt b) { return lor(!a, b); }
