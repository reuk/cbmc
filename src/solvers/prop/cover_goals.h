/// \file Cover a set of goals incrementally
...
/// Try to cover some given set of goals incrementally.          This can be
/// seen as a heuristic variant of          SAT-based set-cover. No minimality
/// guarantee.
