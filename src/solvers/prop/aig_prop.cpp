...
///
/// \returns These vectors filled in with per node phase information
...
///
/// \returns These vectors filled in with per node usage information
...
///
/// parameters: The node to convert, the phases required and the usage counts.
///
/// \returns The node converted to CNF in the solver object.
