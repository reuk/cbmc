...
public:
  ...
  static symbol_exprt
  fresh_symbol(const irep_idt &prefix, const typet &type= bool_typet());
  ...
  void
  set_string_symbol_equal_to_expr(const symbol_exprt &sym, const exprt &str);
...
private:
  ...
  string_exprt
  add_axioms_for_concat(const string_exprt &s1, const string_exprt &s2);
  ...
  string_exprt
  add_axioms_for_constant(irep_idt sval, const refined_string_typet &ref_type);
  ...
  string_exprt
  add_axioms_from_int_hex(const exprt &i, const refined_string_typet &ref_type);
  ...
  string_exprt
  add_axioms_from_bool(const exprt &i, const refined_string_typet &ref_type);
  string_exprt add_axioms_from_char(const function_application_exprt &f);
  string_exprt
  add_axioms_from_char(const exprt &i, const refined_string_typet &ref_type);
  ...
  string_exprt
  add_axioms_from_float(const exprt &f, bool double_precision= false);
