/// \file Generates string constraints for functions adding content        add
/// the end of strings
...
///
/// parameters: two string expressions
///
...
///
/// parameters: function application with two arguments: a string and a integer
///   of type long
///
/// \returns a new string expression
...
///
/// parameters: function application with two arguments: a string and a char
///
/// \returns a new string expression
...
///
/// parameters: function application with two arguments: a string and a double
///
/// \returns a new string expression
...
///
/// parameters: function application with two arguments: a string and a float
///
/// \returns a new string expression
...
///
/// parameters: function application with two arguments: a string and a code
///   point
///
/// \returns a new string expression
