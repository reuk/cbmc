...
exprt string_constraint_generatort::add_axioms_for_is_prefix(
  ...
  implies_exprt a1(isprefix, str.axiom_for_is_longer_than(
  ...
  or_exprt s0_notpref_s1(
      ...
      and_exprt(witness_diff, str.axiom_for_is_longer_than(
                                  plus_exprt(prefix.length(), offset))));
...
exprt string_constraint_generatort::add_axioms_for_is_suffix(
  ...
  or_exprt constr3(
      ...
      and_exprt(notequal_exprt(s0[witness], s1[shifted]),
                and_exprt(s0.axiom_for_is_strictly_longer_than(witness),
                          axiom_for_is_positive_index(witness))));
...
exprt string_constraint_generatort::add_axioms_for_contains(
  ...
  and_exprt a2(axiom_for_is_positive_index(startpos),
