/// \file Generates string constraints for string transformations,        that
/// is, functions taking one string and returning another
...
///
/// parameters: function application with two arguments, the first of which is
///   a string and the second an integer which should have same type has return
///   by get_index_type()
///
...
/// than the end index
///
/// parameters: function application with one string argument, one start index
...
/// add axioms stating that the returned string expression is equal to the
/// input one starting at `start` and ending before `end`
///
/// parameters: a string expression, an expression for the start index, and an
...
/// StringBuilder.setCharAt java function Warning: this may be underspecified
/// in the case wher the index exceed the length of the string
///
...
///
/// parameters: function application with two arguments, the first is a string
...
///
/// parameters: function application with three arguments: a string expression,
