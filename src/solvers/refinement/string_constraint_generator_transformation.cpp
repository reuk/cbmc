...
string_exprt string_constraint_generatort::add_axioms_for_set_length(
  ...
  symbol_exprt idx =
      fresh_univ_index("QA_index_set_length", ref_type.get_index_type());
  string_constraintt a2(
      idx, k,
      and_exprt(implies_exprt(s1.axiom_for_is_strictly_longer_than(idx),
                              equal_exprt(s1[idx], res[idx])),
                implies_exprt(
                    s1.axiom_for_is_shorter_than(idx),
                    equal_exprt(s1[idx],
                                constant_char(0, ref_type.get_char_type())))));
  axioms.push_back(a2);
...
string_exprt string_constraint_generatort::add_axioms_for_substring(
  ...
  implies_exprt a1(binary_relation_exprt(start, ID_lt, end),
  ...
  string_constraintt a4(idx, res.length(),
...
string_exprt string_constraint_generatort::add_axioms_for_trim(
  ...
  exprt a4 = res.axiom_for_is_longer_than(from_integer(0, index_type));
  axioms.push_back(a4);
  ...
  binary_relation_exprt eqn2(str[plus_exprt(idx, plus_exprt(res.length(), n2))],
                             ID_le, space_char);
  ...
  minus_exprt index_before(plus_exprt(idx, res.length()),
                           from_integer(1, index_type));
  binary_relation_exprt no_space_before(str[index_before], ID_gt, space_char);
  or_exprt a9(equal_exprt(idx, str.length()),
...
string_exprt string_constraint_generatort::add_axioms_for_to_lower_case(
  ...
  exprt is_upper_case =
      and_exprt(binary_relation_exprt(char_A, ID_le, str[idx]),
...
string_exprt string_constraint_generatort::add_axioms_for_char_set(
  ...
  implies_exprt a1(binary_relation_exprt(args(f, 3)[1], ID_lt, str.length()),
...
string_exprt string_constraint_generatort::add_axioms_for_replace(
  ...
  implies_exprt case1(equal_exprt(str[qvar], old_char),
                      equal_exprt(res[qvar], new_char));
  implies_exprt case2(not_exprt(equal_exprt(str[qvar], old_char)),
