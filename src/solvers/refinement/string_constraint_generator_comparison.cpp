...
exprt string_constraint_generatort::character_equals_ignore_case(
  ...
  and_exprt is_upper_case_1(binary_relation_exprt(char_A, ID_le, char1),
                            binary_relation_exprt(char1, ID_le, char_Z));
  and_exprt is_upper_case_2(binary_relation_exprt(char_A, ID_le, char2),
...
exprt string_constraint_generatort::add_axioms_for_equals_ignore_case(
  ...
  and_exprt bound_witness(binary_relation_exprt(witness, ID_lt, s1.length()),
                          binary_relation_exprt(witness, ID_ge, zero));
  exprt witness_eq = character_equals_ignore_case(s1[witness], s2[witness],
                                                  char_a, char_A, char_Z);
...
exprt string_constraint_generatort::add_axioms_for_compare_to(
  ...
  equal_exprt ret_char_diff(res,
                            minus_exprt(typecast_exprt(s1[x], return_type),
                                        typecast_exprt(s2[x], return_type)));
  equal_exprt ret_length_diff(
      res, minus_exprt(typecast_exprt(s1.length(), return_type),
                       typecast_exprt(s2.length(), return_type)));
  or_exprt guard1(and_exprt(s1.axiom_for_is_shorter_than(s2),
  ...
  or_exprt guard2(and_exprt(s2.axiom_for_is_strictly_longer_than(s1),
