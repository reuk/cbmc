/// \file Type for string expressions used by the string solver.        These
/// string expressions contain a field `length`, of type        `index_type`, a
/// field `content` of type `content_type`.        This module also defines
/// functions to recognise the C and java        string types.
...
/// parameters: a type
///
/// \returns Boolean telling whether the type is that of C strings
...
/// parameters: a type
///
/// \returns Boolean telling whether the type is that of java string pointers
...
/// parameters: a type
///
/// \returns Boolean telling whether the type is that of java string
...
/// parameters: a type
///
/// \returns Boolean telling whether the type is that of java string builder
...
/// parameters: a type
///
/// \returns Boolean telling whether the type is that of java char sequence
