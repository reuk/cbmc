/// \file Remove symbols that are internal only
...
/// extern inline * symbol used in an EXPORTED symbol * type used in an
/// EXPORTED symbol
///
///          Read
...
///
/// \returns symbol table, with internal symbols removed
