...
std::ostream &goto_difft::output_functions(std::ostream &out) const {
  ...
  case ui_message_handlert::PLAIN: {
    ...
    for (irep_id_sett::const_iterator it = new_functions.begin();
      ...
      out << "  " << program.instructions.begin()->source_location.get_file()
          << ": " << *it << "\n";
    }
  ...
  case ui_message_handlert::JSON_UI: {
    ...
    convert_function_group(json_result["newFunctions"].make_array(),
                           new_functions);
    convert_function_group(json_result["modifiedFunctions"].make_array(),
                           modified_functions);
    convert_function_group(json_result["deletedFunctions"].make_array(),
                           deleted_functions);
    out << ",\n" << json_result;
    break;
  }
...
void goto_difft::convert_function_group(
    json_arrayt &result, const irep_id_sett &function_group) const {
