...
/// written in LHS
///
/// \param equation: symex trace open_variables - target set
///
/// \returns None. But open_variables is modified as a side-effect.
...
///
/// \param equation: symex trace to be sliced expression - list of expressions,
///   targets for slicing
///
/// \returns None. But equation is modified as a side-effect.
void slice(symex_target_equationt &equation,
