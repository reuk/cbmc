/// \file Compute dominators for CFG of goto_function
...
/// Pretty-print a single node in the dominator tree. Supply a specialisation
/// if operator<< is not sufficient.
///
/// parameters: `node` to print and stream `out` to pretty-print it to
template <class T>
