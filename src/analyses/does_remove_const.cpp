...
/// A naive analysis to look for casts that remove const-ness from pointers.
///
/// \returns Returns true if the program contains a const-removing cast
...
///
/// \returns Returns true if somewhere in the passed expression tree the const-
///   ness is lost.
...
///   const qualified
///
/// \returns Returns true if type_more_const is at least as const as
///   type_compare
