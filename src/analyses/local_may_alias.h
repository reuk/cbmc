...
public:
  ...
  std::set<exprt> get(const goto_programt::const_targett t,
                      const exprt &src) const;

  // returns 'true' when pointers src1 and src2 may be aliases
  bool aliases(const goto_programt::const_targett t, const exprt &src1,
...
protected:
  ...
  void get_rec(object_sett &dest, const exprt &rhs,
