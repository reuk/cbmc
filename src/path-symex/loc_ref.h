...
public:
  ...
  void increase() { loc_number++; }

  void decrease() { loc_number--; }

  bool is_nil() const { return loc_number == nil().loc_number; }

  loc_reft()
      : loc_number(-1) // ugly conversion
  {}

  static inline loc_reft nil() { return loc_reft(); }
