/// \file Constant Function Pointer Propagation
...
///   function actually called, 'stack_scope' the place where the constant was
...
/// adds const pointers (instantiated here or propagated) passed as arguments
/// in the map
