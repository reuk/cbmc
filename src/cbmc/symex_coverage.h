...
public:
  ...
  void covered(goto_programt::const_targett from,
  ...
  bool generate_report(const goto_functionst &goto_functions,
...
protected:
  ...
  struct coverage_infot {
    coverage_infot(goto_programt::const_targett _from,
                   goto_programt::const_targett _to, unsigned _num_executions)
  ...
  bool output_report(const goto_functionst &goto_functions,
                     std::ostream &os) const;

  void build_cobertura(const goto_functionst &goto_functions,
                       xmlt &xml_coverage) const;

  void compute_overall_coverage(const goto_functionst &goto_functions,
