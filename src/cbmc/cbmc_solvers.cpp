/// \file Solvers for VCs Generated by Symbolic Execution of ANSI-C
...
/// parameters: None
///
/// \returns An smt1_dect::solvert giving the solver to use.
...
/// parameters: None
///
/// \returns An smt2_dect::solvert giving the solver to use.
