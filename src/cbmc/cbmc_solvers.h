...
public:
  cbmc_solverst(const optionst &_options, const symbol_tablet &_symbol_table,
                message_handlert &_message_handler)
      : messaget(_message_handler), options(_options),
  ...
  public:
    ...
    void set_prop(propt *p) { prop_ptr = std::unique_ptr<propt>(p); }
