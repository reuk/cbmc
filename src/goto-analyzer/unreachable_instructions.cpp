...
static void
unreachable_instructions(const goto_programt &goto_program, dead_mapt &dest)
{
  ...
  std::ostream &os)
{
  ...
  forall_goto_functions(f_it, goto_model.goto_functions)
  {
    ...
    if(called.find(decl.base_name) != called.end() || f_it->second.is_inlined())
  ...
  forall_goto_functions(f_it, goto_model.goto_functions)
  {
    ...
    if(!json)
    {
      ...
      json_output_function(
        decl.base_name, first_location, last_location, json_result);
  }
