...
public:
  ...
  public:
    ...
    bool is_source() const { return kind == SOURCE; }

    bool is_sink() const { return kind == SINK; }

    bool is_sanitizer() const { return kind == SANITIZER; }
...
bool taint_parser(const std::string &taint_file_name, taint_parse_treet &,
                  message_handlert &);
