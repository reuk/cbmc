...
public:
  ...
  void output_entry(const entryt &e, const namespacet &ns,
...
protected:
  ...
  void get_reference_set(const exprt &expr, object_mapt &dest,
                         const namespacet &ns) const {
    get_reference_set_rec(expr, dest, ns);
  }

  void get_reference_set_rec(const exprt &expr, object_mapt &dest,
                             const namespacet &ns) const;
