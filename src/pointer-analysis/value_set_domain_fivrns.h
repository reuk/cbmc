...
class value_set_domain_fivrnst : public flow_insensitive_abstract_domain_baset {
public:
  ...
  virtual void initialize(const namespacet &ns) { value_set.clear(); }

  virtual bool transform(const namespacet &ns, locationt from_l,
                         locationt to_l);
  ...
  virtual void clear(void) { value_set.clear(); }
};
