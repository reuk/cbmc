...
public:
  ...
  void get_value_set(const exprt &expr, value_setst::valuest &dest,
  ...
  void assign(const exprt &lhs, const exprt &rhs, const namespacet &ns,
              bool is_simplified, bool add_to_sets);
  ...
  void get_reference_set(const exprt &expr, value_setst::valuest &dest,
                         const namespacet &ns) const;
...
protected:
  ...
  exprt make_member(const exprt &src, const irep_idt &component_name,
                    const namespacet &ns);
};
