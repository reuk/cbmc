...
/// parameters: parent_base_name: base name of typechecked parent block: non-
///   typechecked block
///
/// \returns generate code to copy the parent
...
/// parameters: member_base_name: name of a member block: non-typechecked block
///
/// \returns generate code to copy the member
...
/// parameters: member_base_name: name of array member index: index to copy
...
///
/// parameters: bases: the parents of the class components: the components of
///   the class initializers: the constructor initializers
///
/// \returns If an invalid initializer is found, then the method outputs an
///   error message and throws a 0 exception.
...
///
/// parameters: struct_union_type: the class/struct/union initializers: the
///   constructor initializers
///
/// \returns initializers is updated.
...
///
/// \returns return true if a copy constructor is found
