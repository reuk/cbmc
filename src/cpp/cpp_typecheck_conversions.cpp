...
///
/// \returns True iff the lvalue-to-rvalue conversion is possible. 'new_type'
...
///
/// \returns True iff the array-to-pointer conversion is possible. The result
...
///
/// parameters: A typechecked expression 'expr', a destination type 'type'
///
/// \returns True iff the qualification conversion is possible. The result of
...
///
/// \returns True iff the integral pormotion is possible. The result of the
...
/// parameters: A typechecked expression 'expr'
///
/// \returns True iff the integral promotion is possible. The result of the
///   conversion is stored in 'new_expr'.
...
/// parameters: A typechecked expression 'expr'
///
/// \returns True iff the conversion is possible. The result of the conversion
///   is stored in 'new_expr'.
...
/// parameters: A typechecked expression 'expr', a destination type 'type'
///
/// \returns True iff the floating-point conversion is possible. The result of
///   the conversion is stored in 'new_expr'.
...
/// parameters: A typechecked expression 'expr', a destination type 'type'
///
/// \returns True iff the pointer conversion is possible. The result of the
///   conversion is stored in 'new_expr'.
...
/// parameters: A typechecked expression 'expr', a destination type 'type'
///
/// \returns True iff the pointer-to-member conversion is possible. The result
///   of the conversion is stored in 'new_expr'.
...
/// parameters: A typechecked expression 'expr'
///
/// \returns True iff the boolean conversion is possible. The result of the
///   conversion is stored in 'new_expr'.
...
/// parameters: A typechecked expression 'expr', a destination type 'type'.
///
/// \returns True iff a standard conversion sequence exists. The result of the
...
/// parameters: A typechecked expression 'expr', a destination type 'type'.
///
/// \returns True iff a user-defined conversion sequence exists. The result of
///   the conversion is stored in 'new_expr'.
...
/// Reference-related
///
/// parameters: A typechecked expression 'expr', a reference 'type'.
///
/// \returns True iff an the reference 'type' is reference-related to 'expr'.
...
/// parameters: A typechecked expression 'expr', a reference 'type'.
///
/// \returns True iff an the reference 'type' is reference-compatible to
///   'expr'.
...
/// parameters: A typechecked expression 'expr', a reference 'type'.
///
/// \returns True iff an the reference can be bound to the expression. The
///   result of the conversion is stored in 'new_expr'.
...
/// parameters: A typechecked expression 'expr', a destination type 'type'.
///
/// \returns True iff an implicit conversion sequence exists. The result of the
...
/// parameters: A typechecked expression 'expr', a destination type 'type'.
///
/// \returns True iff an implicit conversion sequence exists. The rank of the
