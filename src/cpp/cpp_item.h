...
public:
  ...
  bool is_declaration() const { return id() == ID_cpp_declaration; }
  ...
  bool is_linkage_spec() const { return id() == ID_cpp_linkage_spec; }
  ...
  bool is_namespace_spec() const { return id() == ID_cpp_namespace_spec; }
  ...
  bool is_using() const { return id() == ID_cpp_using; }
  ...
  bool is_static_assert() const { return id() == ID_cpp_static_assert; }
