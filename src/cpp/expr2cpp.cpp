...
protected:
  ...
  std::string convert_constant(const constant_exprt &src,
                               unsigned &precedence) override;

  std::string convert_rec(const typet &src, const c_qualifierst &qualifiers,
...
std::string expr2cppt::convert_rec(const typet &src,
