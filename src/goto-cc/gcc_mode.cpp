...
static std::string
compiler_name(const cmdlinet &cmdline, const std::string &base_name)
{
...
gcc_modet::gcc_modet(
  ...
  : goto_cc_modet(_cmdline, _base_name, gcc_message_handler),
    ...
    act_as_ld(
      base_name == "ld" || base_name.find("goto-ld") != std::string::npos)
{
}
...
{
  if(
    has_suffix(file, ".c") || has_suffix(file, ".cc") ||
...
int gcc_modet::doit()
{
  ...
  if(
    (cmdline.isset('v') || cmdline.isset("version")) &&
  ...
  if(act_as_ld)
  {
    ...
    cmdline.isset('M') || cmdline.isset("MM") || cmdline.isset('E') ||
  ...
  else if(cmdline.isset('E'))
  {
    ...
    cmdline.isset("shared") || cmdline.isset('r')) // really not well documented
  ...
  if(cmdline.isset("std"))
  {
    ...
    if(
      std_string == "gnu99" || std_string == "c99" ||
      std_string == "iso9899:1999" || std_string == "gnu9x" ||
      std_string == "c9x" || std_string == "iso9899:199x")
      config.ansi_c.set_c99();

    if(
      std_string == "gnu11" || std_string == "c11" || std_string == "gnu1x" ||
      std_string == "c1x")
      config.ansi_c.set_c11();

    if(
      std_string == "c++11" || std_string == "c++1x" ||
