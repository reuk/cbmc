...
const char *as86_options_with_argument[] = {"-lm", "-l", "-n", "-o",
                                            "-b",  "-s", "-t", NULL};
...
bool as86_cmdlinet::parse(int argc, const char **argv) {
  ...
  for (int i = 1; i < argc; i++) {
    ...
    for (const char **o = goto_as86_options_with_argument; *o != NULL && !found;
         ++o) {
      std::string os(*o);
    ...
    for (const char **o = as86_options_with_argument; *o != NULL && !found;
         ++o) {
      std::string os(*o);
