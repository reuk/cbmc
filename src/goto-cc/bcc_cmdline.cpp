...
const char *bcc_options_without_argument[]= {"-0",
                                             "-3",
                                             "-E",
                                             "-G",
                                             "-N",
...
const char *bcc_options_with_argument[]= {"-A",
                                          "-B",
                                          "-D",
                                          "-U",
                                          "-M",
...
bool bcc_cmdlinet::parse(int argc, const char **argv)
{
  ...
  for(int i= 1; i < argc; i++)
  {
    ...
    for(const char **o= goto_bcc_options_with_argument; *o != NULL && !found;
        ++o)
    {
      std::string os(*o);
    ...
    for(const char **o= bcc_options_with_argument; *o != NULL && !found; ++o)
    {
      std::string os(*o);
