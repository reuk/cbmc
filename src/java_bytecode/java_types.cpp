...
typet java_void_type() { return void_typet(); }
...
typet java_char_type() { return unsignedbv_typet(16); }
...
bool is_reference_type(const char t) { return 'a' == t; }
...
typet java_type_from_char(char t) {
  ...
  case 'a':
    return java_reference_type(void_typet());
  default:
    assert(false);
    return nil_typet();
  }
