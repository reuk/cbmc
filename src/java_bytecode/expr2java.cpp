...
std::string
expr2javat::convert_code_function_call(const code_function_callt &src,
                                       unsigned indent) {
...
std::string expr2javat::convert_constant(const constant_exprt &src,
                                         unsigned &precedence) {
...
std::string expr2javat::convert_rec(const typet &src,
...
std::string expr2javat::convert_java_this(const exprt &src,
                                          unsigned precedence) {
  return "this";
}
...
std::string expr2javat::convert_code_java_delete(const exprt &src,
                                                 unsigned indent) {
