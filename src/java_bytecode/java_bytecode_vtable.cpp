...
public:
  ...
  {
    for(irept::subt::const_iterator it= types.begin(); it != types.end(); ++it)
    {
...
static void
add_vtable_pointer_member(const irep_idt &vt_name, symbolt &class_symbol)
{
