...
public:
  string_abstractiont(symbol_tablet &_symbol_table,
...
protected:
  ...
  void make_type(exprt &dest, const typet &type) {
    if (dest.is_not_nil() && ns.follow(dest.type()) != ns.follow(type))
      dest.make_typecast(type);
  }

  goto_programt::targett abstract(goto_programt &dest,
                                  goto_programt::targett it);
  goto_programt::targett abstract_assign(goto_programt &dest,
                                         goto_programt::targett it);
  goto_programt::targett abstract_pointer_assign(goto_programt &dest,
                                                 goto_programt::targett it);
  goto_programt::targett abstract_char_assign(goto_programt &dest,
                                              goto_programt::targett it);

  goto_programt::targett char_assign(goto_programt &dest,
                                     goto_programt::targett target,
                                     const exprt &new_lhs, const exprt &lhs,
                                     const exprt &rhs);
  ...
  goto_programt::targett value_assignments_if(goto_programt &dest,
                                              goto_programt::targett target,
                                              const exprt &lhs,
                                              const if_exprt &rhs);

  goto_programt::targett
  value_assignments_string_struct(goto_programt &dest,
                                  goto_programt::targett target,
                                  const exprt &lhs, const exprt &rhs);
  ...
  exprt build(const exprt &pointer, whatt what, bool write,
  ...
  void build_new_symbol(const symbolt &symbol, const irep_idt &identifier,
                        const typet &type);
  ...
  void add_str_arguments(const irep_idt &name,
                         goto_functionst::goto_functiont &fct);

  void add_argument(code_typet::parameterst &str_args,
                    const symbolt &fct_symbol, const typet &type,
                    const irep_idt &base_name, const irep_idt &identifier);
  ...
  symbol_exprt add_dummy_symbol_and_value(goto_programt &dest,
                                          goto_programt::targett ref_instr,
...
void string_abstraction(symbol_tablet &symbol_table,
                        message_handlert &message_handler, goto_programt &dest);
