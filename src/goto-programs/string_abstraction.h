...
protected:
  ...
  abstract(goto_programt &dest, goto_programt::targett it);
  goto_programt::targett
  abstract_assign(goto_programt &dest, goto_programt::targett it);
  goto_programt::targett
  abstract_pointer_assign(goto_programt &dest, goto_programt::targett it);
  goto_programt::targett
  abstract_char_assign(goto_programt &dest, goto_programt::targett it);
  ...
  goto_programt::targett value_assignments(
    goto_programt &dest,
  ...
  exprt
  build(const exprt &pointer, whatt what, bool write, const source_locationt &);
  ...
  const typet &build_abstraction_type_rec(
    const typet &type,
  ...
  void
  add_str_arguments(const irep_idt &name, goto_functionst::goto_functiont &fct);
