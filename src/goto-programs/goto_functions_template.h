...
template <class bodyT> class goto_function_templatet {
public:
  bodyT body;
  code_typet type;
  ...
  bool body_available() const { return !body.instructions.empty(); }

  bool is_inlined() const { return type.get_bool(ID_C_inlined); }

  bool is_hidden() const { return type.get_bool(ID_C_hide); }

  void make_hidden() { type.set(ID_C_hide, true); }
...
template <class bodyT> class goto_functions_templatet {
public:
