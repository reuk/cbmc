  ...
  goto_programt &dest)
{
  ...
  if(identifier == CPROVER_PREFIX "assume" || identifier == "__VERIFIER_assume")
  {
    if(arguments.size() != 1)
    {
      error().source_location= function.find_source_location();
  ...
  else if(has_prefix(id2string(identifier), CPROVER_PREFIX "prob_uniform_"))
  {
    ...
    has_prefix(id2string(identifier), "nondet_") ||
  ...
  */
    ...
    identifier == "__sync_fetch_and_nand")
  {
    ...
    irep_idt op_id= identifier == "__sync_fetch_and_add"
                      ? ID_plus
                      : identifier == "__sync_fetch_and_sub"
                          ? ID_minus
                          : identifier == "__sync_fetch_and_or"
    ...
    identifier == "__sync_nand_and_fetch")
  {
    ...
    irep_idt op_id= identifier == "__sync_add_and_fetch"
                      ? ID_plus
                      : identifier == "__sync_sub_and_fetch"
                          ? ID_minus
                          : identifier == "__sync_or_and_fetch"
