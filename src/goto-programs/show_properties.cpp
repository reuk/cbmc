...
void show_properties(const namespacet &ns, const irep_idt &identifier,
...
void show_properties_json(json_arrayt &json_properties, const namespacet &ns,
...
void show_properties_json(const namespacet &ns,
  ...
  for (const auto &fct : goto_functions.function_map)
    if (!fct.second.is_inlined())
      show_properties_json(json_properties, ns, fct.first, fct.second.body);
...
void show_properties(const namespacet &ns, ui_message_handlert::uit ui,
                     const goto_functionst &goto_functions) {
