...
///
/// parameters: `this_id`: class name `last_method_defn`: the most-derived
///   parent of `this_id` to define the requested function `component_name`:
///   name of the function searched for
///
/// \returns `functions` is assigned a list of {class name, function symbol}
