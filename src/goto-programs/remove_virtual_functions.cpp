  ...
  std::set<irep_idt> &visited) const
{
  ...
  for(const auto &child : findit->second.children)
  {
    ...
    get_child_functions_rec(
      child, function.symbol_expr, component_name, functions, visited);
  }
}
  ...
  functionst &functions)
{
  ...
  while(!c.empty())
  {
    ...
    const class_hierarchyt::idst &parents= class_hierarchy.class_map[c].parents;
  ...
  get_child_functions_rec(
    class_id, root_function.symbol_expr, component_name, functions, visited);
