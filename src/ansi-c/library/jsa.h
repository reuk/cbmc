...
#define __CPROVER_JSA_MAX_NODES                                                \
  __CPROVER_JSA_MAX_CONCRETE_NODES + __CPROVER_JSA_MAX_ABSTRACT_NODES
#endif
...
__CPROVER_jsa_inline _Bool __CPROVER_jsa__internal_are_heaps_equal(
  ...
  for (i = 0; i < __CPROVER_JSA_MAX_ABSTRACT_NODES; ++i) {
    ...
    if (lhs_node.list != rhs_node.list || lhs_node.next != rhs_node.next ||
  ...
  for (i = 0; i < __CPROVER_JSA_MAX_ABSTRACT_RANGES; ++i) {
    ...
    if (lhs_range.max != rhs_range.max || lhs_range.min != rhs_range.min ||
  ...
  for (i = 0; i < lhs->iterator_count; ++i) {
    ...
    if (lhs_it.index != rhs_it.index || lhs_it.list != rhs_it.list ||
...
#define __CPROVER_jsa__internal_get_list(heap_ptr, node)                       \
  (__CPROVER_jsa_null == node ? __CPROVER_jsa_null                             \
                              : __CPROVER_jsa__internal_is_concrete_node(node) \
                                    ? (heap_ptr)->concrete_nodes[node].list    \
                                    : (heap_ptr)->abstract_nodes[node].list)

__CPROVER_jsa_inline void
__CPROVER_jsa__internal_set_next(__CPROVER_jsa_abstract_heapt *const heap,
...
#define __CPROVER_jsa__internal_get_next(heap_ptr, node)                       \
  (__CPROVER_jsa__internal_is_concrete_node(node)                              \
       ...
       : (heap_ptr)                                                            \
             ->abstract_nodes[__CPROVER_jsa__internal_get_abstract_node_index( \
                 node)]                                                        \
             .next)
...
__CPROVER_jsa_inline __CPROVER_jsa_node_id_t
__CPROVER_jsa__internal_remove(__CPROVER_jsa_abstract_heapt *const heap,
...
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
  ...
  __CPROVER_jsa__internal_set_previous(heap, node_id_to_remove,
                                       __CPROVER_jsa_null);
...
__CPROVER_jsa_inline void
__CPROVER_jsa__internal_make_null(__CPROVER_jsa_abstract_heapt *const heap,
...
__CPROVER_jsa_inline _Bool
__CPROVER_jsa__internal_is_valid_node_id(const __CPROVER_jsa_node_id_t node_id)
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
...
__CPROVER_jsa_inline void __CPROVER_jsa__internal_assume_linking_correct(
    const __CPROVER_jsa_abstract_heapt *const heap,
    const __CPROVER_jsa_node_id_t node_id, const __CPROVER_jsa_node_id_t prev,
...
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
  ...
  if (__CPROVER_jsa_null != prev) {
    __CPROVER_jsa_assume(node_id ==
                         __CPROVER_jsa__internal_get_next(heap, prev));
...
__CPROVER_jsa_inline void __CPROVER_jsa__internal_assume_valid_iterator_linking(
    ...
    const __CPROVER_jsa_list_id_t list, const __CPROVER_jsa_node_id_t node_id,
    const __CPROVER_jsa_index_t index)
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
...
__CPROVER_jsa_inline __CPROVER_jsa_index_t
...
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
  if (__CPROVER_jsa__internal_is_concrete_node(lhs_node_id)) {
    ...
    __CPROVER_jsa_assume(
        heap->concrete_nodes[lhs_node_id].next == rhs_node_id ||
    ...
    if (node.next == rhs_node_id) {
      ...
      __CPROVER_jsa_assume(lhs_index == __CPROVER_jsa__internal_get_max_index(
                                            heap, lhs_node_id));
    } else {
      __CPROVER_jsa_assume(node.previous == rhs_node_id);
      __CPROVER_jsa_assume(lhs_index == 0);
      __CPROVER_jsa_assume(rhs_index == __CPROVER_jsa__internal_get_max_index(
                                            heap, rhs_node_id));
    }
  }
}
...
__CPROVER_jsa_inline void
__CPROVER_jsa_assume_valid_list(const __CPROVER_jsa_abstract_heapt *const h,
                                const __CPROVER_jsa_list_id_t list)
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
...
__CPROVER_jsa_inline void
__CPROVER_jsa_assume_new_list(const __CPROVER_jsa_abstract_heapt *const h,
                              const __CPROVER_jsa_list_id_t list)
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
...
__CPROVER_jsa_inline void
__CPROVER_jsa_assume_valid_iterator(const __CPROVER_jsa_abstract_heapt *const h,
                                    const __CPROVER_jsa_iterator_id_t it)
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
...
__CPROVER_jsa_inline void
__CPROVER_jsa_assume_valid_heap(const __CPROVER_jsa_abstract_heapt *const h)
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
  ...
  for (__CPROVER_jsa_list_id_t list = 0; list < __CPROVER_JSA_MAX_LISTS;
       ++list) {
  ...
  for (__CPROVER_jsa__internal_index_t anode = 0;
       anode < __CPROVER_JSA_MAX_ABSTRACT_NODES; ++anode) {
  ...
  for (__CPROVER_jsa__internal_index_t range = 0;
       range < __CPROVER_JSA_MAX_ABSTRACT_RANGES; ++range) {
  ...
  for (__CPROVER_jsa_iterator_id_t it = 0; it < __CPROVER_JSA_MAX_ITERATORS;
       ++it) {
    ...
    if (it >= h->iterator_count) {
      ...
      __CPROVER_jsa_assume(list < h->list_count);
      __CPROVER_jsa__internal_assume_valid_iterator_linking(h, list, next_node,
                                                            next_index);
      __CPROVER_jsa__internal_assume_valid_iterator_linking(h, list, prev_node,
                                                            prev_index);
      if (__CPROVER_jsa_null != next_node && __CPROVER_jsa_null != prev_node)
        __CPROVER_jsa__internal_assume_is_neighbour(h, next_node, next_index,
                                                    prev_node, prev_index);
    }
  }
  // Limit list sizes in counterexamples
  for (__CPROVER_jsa__internal_index_t listc = 0;
       listc < __CPROVER_JSA_MAX_LISTS; ++listc) {
    __CPROVER_jsa__internal_index_t count = 0;
    for (__CPROVER_jsa__internal_index_t cnodec = 0;
         cnodec < __CPROVER_JSA_MAX_CONCRETE_NODES; ++cnodec)
      if (h->concrete_nodes[cnodec].list == listc)
        ++count;
    for (__CPROVER_jsa__internal_index_t anodec = 0;
         anodec < __CPROVER_JSA_MAX_ABSTRACT_NODES; ++anodec)
...
__CPROVER_jsa_inline __CPROVER_jsa_list_id_t
__CPROVER_jsa_create_list(__CPROVER_jsa_abstract_heapt *const heap)
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
...
__CPROVER_jsa_inline __CPROVER_jsa_iterator_id_t
__CPROVER_jsa_iterator(__CPROVER_jsa_abstract_heapt *const heap,
                       const __CPROVER_jsa_list_id_t list)
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
...
__CPROVER_jsa_inline __CPROVER_jsa_data_t
__CPROVER_jsa_next(__CPROVER_jsa_abstract_heapt *const heap,
                   const __CPROVER_jsa_iterator_id_t it)
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
...
__CPROVER_jsa_inline void
__CPROVER_jsa_remove(__CPROVER_jsa_abstract_heapt *const heap,
                     const __CPROVER_jsa_iterator_id_t it)
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
...
__CPROVER_jsa_inline void
__CPROVER_jsa_set(__CPROVER_jsa_abstract_heapt *const heap,
                  const __CPROVER_jsa_iterator_id_t it,
                  const __CPROVER_jsa_word_t value)
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
  const __CPROVER_jsa_id_t node_id_to_set =
      heap->iterators[it].previous_node_id;
...
__CPROVER_jsa_inline void
__CPROVER_jsa_add(__CPROVER_jsa_abstract_heapt *const heap,
                  const __CPROVER_jsa_list_id_t list,
                  const __CPROVER_jsa_word_t value)
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
  ...
  if (__CPROVER_jsa_null == head_node) {
    ...
    for (__CPROVER_jsa__internal_index_t i = 0; i < __CPROVER_JSA_MAX_NODES;
         ++i) {
      const __CPROVER_jsa_node_id_t next_node =
          __CPROVER_jsa__internal_get_next(heap, last_node);
...
__CPROVER_jsa_inline __CPROVER_jsa_word_t __CPROVER_jsa_minus(
    const __CPROVER_jsa_word_t lhs, const __CPROVER_jsa_word_t rhs)
#ifdef __CPROVER_JSA_DEFINE_TRANSFORMERS
{
  if (lhs >= rhs)
    return lhs - rhs;
...
__CPROVER_jsa_inline __CPROVER_jsa_word_t __CPROVER_jsa_ite(
    const __CPROVER_jsa_word_t res, const __CPROVER_jsa_word_t lhs,
...
__CPROVER_jsa_inline void
__CPROVER_jsa_assume_valid_pred(const __CPROVER_jsa_pred_id_t pred_id) {
  __CPROVER_jsa_assert(
      __CPROVER_JSA_PRED_OPS_COUNT <= __CPROVER_JSA_NUM_PRED_OPS,
      "__CPROVER_JSA_PRED_OPS_COUNT <= __CPROVER_JSA_NUM_PRED_OPS");
  __CPROVER_jsa_assert(__CPROVER_JSA_PRED_RESULT_OPS_COUNT <=
  ...
  for (__CPROVER_jsa__internal_index_t i = 0; i < __CPROVER_JSA_MAX_PRED_SIZE;
       ++i) {
    if (i >= sz)
      break;
...
__CPROVER_jsa_inline __CPROVER_jsa_word_t
__CPROVER_jsa_execute_pred(const __CPROVER_jsa_pred_id_t pred_id) {
  const __CPROVER_jsa_pred_instructiont *const pred =
      __CPROVER_JSA_PREDICATES[pred_id];
...
#define __CPROVER_jsa_execute_pred_result                                      \
  *__CPROVER_jsa_execute_pred_result_op_ptr
    ...
    __CPROVER_jsa_pred_opcode_first_2:
      __CPROVER_jsa_execute_pred_result = __CPROVER_jsa_mod(
          __CPROVER_jsa_execute_pred_op0, __CPROVER_jsa_execute_pred_op1);
    ...
    __CPROVER_jsa_pred_opcode_first_4:
      __CPROVER_jsa_execute_pred_result = __CPROVER_jsa_minus(
          __CPROVER_jsa_execute_pred_op0, __CPROVER_jsa_execute_pred_op1);
    ...
    __CPROVER_jsa_pred_opcode_first_5:
      __CPROVER_jsa_execute_pred_result = __CPROVER_jsa_plus(
          __CPROVER_jsa_execute_pred_op0, __CPROVER_jsa_execute_pred_op1);
    ...
    __CPROVER_jsa_pred_opcode_first_6:
      __CPROVER_jsa_execute_pred_result = __CPROVER_jsa_mult(
          __CPROVER_jsa_execute_pred_op0, __CPROVER_jsa_execute_pred_op1);
    ...
    __CPROVER_jsa_pred_opcode_first_7:
      __CPROVER_jsa_execute_pred_result = __CPROVER_jsa_div(
          __CPROVER_jsa_execute_pred_op0, __CPROVER_jsa_execute_pred_op1);
...
typedef enum { FILTER = 0, MAP = 1, MAP_IN_PLACE = 2 } __CPROVER_jsa_query_idt;

__CPROVER_jsa_inline void __CPROVER_jsa_stream_op(
    __CPROVER_jsa_abstract_heapt *const heap,
    const __CPROVER_jsa_list_id_t list, const __CPROVER_jsa_iterator_id_t it,
    const __CPROVER_jsa_list_id_t source, const __CPROVER_jsa_pred_id_t pred_id,
...
__CPROVER_jsa_inline void __CPROVER_jsa_assume_valid_query(
  ...
  for (__CPROVER_jsa__internal_index_t i = 1; i < __CPROVER_JSA_MAX_QUERY_SIZE;
       ++i) {
    if (i >= query_size)
      break;
...
__CPROVER_jsa_inline void
__CPROVER_jsa_query_execute(__CPROVER_jsa_abstract_heapt *const heap,
                            const __CPROVER_jsa_query_instructiont *const query,
                            const __CPROVER_jsa__internal_index_t query_size) {
  ...
  __CPROVER_jsa_query_opcode_0:
    __CPROVER_jsa_stream_op(heap, list, it, instr.op1, instr.op0, instr.opcode);
  }
}
...
__CPROVER_jsa_inline void __CPROVER_jsa_verify_synchronise_iterator(
    ...
    const __CPROVER_jsa_iterator_id_t it) {
  for (__CPROVER_jsa__internal_index_t i = 0; i < __CPROVER_JSA_MAX_ITERATORS;
       ++i)
