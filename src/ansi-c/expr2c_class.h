...
protected:
  ...
  virtual std::string convert_rec(const typet &src,
  ...
  std::string convert_struct_member_value(const exprt &src,
                                          unsigned precedence);
  ...
  std::string convert_pointer_object_has_type(const exprt &src,
                                              unsigned precedence);

  std::string convert_array_of(const exprt &src, unsigned precedence);

  std::string convert_trinary(const exprt &src, const std::string &symbol1,
                              const std::string &symbol2, unsigned precedence);

  std::string convert_overflow(const exprt &src, unsigned &precedence);

  std::string convert_quantifier(const exprt &src, const std::string &symbol,
                                 unsigned precedence);
  ...
  std::string convert_unary_post(const exprt &src, const std::string &symbol,
                                 unsigned precedence);
  ...
  std::string convert_code_switch_case(const code_switch_caset &src,
                                       unsigned indent);
  ...
  // NOLINTNEXTLINE(whitespace/line_length)
  std::string convert_code_ifthenelse(const code_ifthenelset &src,
                                      unsigned indent);
  ...
  // NOLINTNEXTLINE(whitespace/line_length)
  std::string convert_statement_expression(const exprt &src,
  ...
  // NOLINTNEXTLINE(whitespace/line_length)
  virtual std::string convert_constant(const constant_exprt &src,
                                       unsigned &precedence);
