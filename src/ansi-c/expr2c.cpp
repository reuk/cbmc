...
///
/// \returns Returns a type declaration for a struct, containing the body of
///   the struct and in that body the padding parameters.
...
///
/// \returns Returns a type declaration for a struct, optionally containing the
...
/// declarator_str
///
/// \returns A C-like type declaration of an array
...
/// To generate a C-like type declaration of an array. Optionally can include
/// or exclude the size of the array in the []
///
/// \param src: The array type to convert
/// qualifier
/// declarator_str
/// \param inc_size_if_possible: Should the generated string include the size
///   of the array (if it is known).
///
/// \returns A C-like type declaration of an array
std::string expr2ct::convert_array_type(
  const typet &src,
...
///
/// \returns Returns a C-like representation of the boolean value, e.g. TRUE or
///   FALSE.
...
///
/// \returns A string representation of the struct expression
std::string expr2ct::convert_struct(
  const exprt &src,
  unsigned &precedence,
