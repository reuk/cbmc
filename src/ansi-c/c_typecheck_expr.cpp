...
void c_typecheck_baset::add_rounding_mode(exprt &expr)
{
  ...
  if(
    expr.id() == ID_div || expr.id() == ID_mult || expr.id() == ID_plus ||
    expr.id() == ID_minus)
  {
  ...
  const typet &type2)
{
  ...
  else if(type1.id() == ID_array && type2.id() == ID_array)
  {
    return gcc_types_compatible_p(
      type1.subtype(), type2.subtype()); // ignore size
  }
...
void c_typecheck_baset::typecheck_expr_main(exprt &expr)
{
  ...
  else if(expr.id() == ID_infinity)
  {
    ...
    expr.id() == ID_unary_plus || expr.id() == ID_unary_minus ||
    expr.id() == ID_bitnot)
  ...
  else if(expr.id() == ID_generic_selection)
  {
    ...
    forall_irep(it, generic_associations)
    {
      if(it->get(ID_type_arg) == ID_default)
        ...
        op_type == follow(static_cast<const typet &>(it->find(ID_type_arg))))
    ...
    expr.id() == ID_gcc_asm_input || expr.id() == ID_gcc_asm_output ||
...
// preserve enum key
  ...
  else if(has_prefix(id2string(identifier), CPROVER_PREFIX "constant_infinity"))
  {
    ...
    identifier == "__func__" || identifier == "__FUNCTION__" ||
...
void c_typecheck_baset::typecheck_expr_typecast(exprt &expr)
{
  ...
  if(
    expr_type.id() == ID_union && !base_type_eq(expr_type, op.type(), *this) &&
...
void c_typecheck_baset::typecheck_expr_index(exprt &expr)
{
...

  {
    ...
    if(
      array_full_type.id() != ID_array && array_full_type.id() != ID_pointer &&
      array_full_type.id() != ID_vector &&
      (index_full_type.id() == ID_array || index_full_type.id() == ID_pointer ||
...
void c_typecheck_baset::typecheck_expr_rel(binary_relation_exprt &expr)
{
  ...
  if(expr.id() == ID_equal || expr.id() == ID_notequal)
  {
    if(follow(o_type0) == follow(o_type1))
    {
      ...
      if(final_type.id() != ID_array && final_type.id() != ID_incomplete_struct)
      {
...
void c_typecheck_baset::typecheck_expr_trinary(if_exprt &expr)
{
    ...
    operands[1].type() != operands[2].type())
  {
    ...
    if(
      ...
      operands[1].type().subtype().id() != ID_code ||
  ...
  if(operands[1].type().id() == ID_empty || operands[2].type().id() == ID_empty)
  {
    expr.type()= void_type();
    return;
  }
...
void c_typecheck_baset::typecheck_expr_address_of(exprt &expr)
{
  ...
  if(
    op.id() == ID_struct || op.id() == ID_union || op.id() == ID_array ||
...
void c_typecheck_baset::typecheck_expr_side_effect(side_effect_exprt &expr)
{
    ...
    statement == ID_postincrement || statement == ID_postdecrement)
  {
    ...
    {
      if(
        follow_tag(to_c_enum_tag_type(final_type0)).id() ==
  ...
  side_effect_expr_function_callt &expr)
{
  ...
  if(f_op.id() == ID_symbol)
  {
    ...
    if(symbol_table.symbols.find(identifier) == symbol_table.symbols.end())
    {
      ...
      if(
        identifier == "malloc" || identifier == "realloc" ||
  ...
  if(
    f_op.id() == ID_address_of && f_op.get_bool(ID_C_implicit) &&
  ...
  side_effect_expr_function_callt &expr)
{
    ...
    identifier == "__builtin_signbitl")
  {
    ...
    identifier == "__builtin_popcount" || identifier == "__builtin_popcountl" ||
    identifier == "__builtin_popcountll" || identifier == "__popcnt16" ||
    identifier == "__popcnt" || identifier == "__popcnt64")
  {
    if(expr.arguments().size() != 1)
    {
      err_location(f_op);
  ...
  else if(identifier == "__builtin_constant_p")
  {
    ...
    if(
      tmp1.id() == ID_typecast && tmp1.operands().size() == 1 &&
                                                     ...
                                                     "float_debug2")
  {
    ...
    identifier == "__sync_fetch_and_add" ||
  ...
  side_effect_expr_function_callt &expr)
{
  ...
  for(unsigned i= 0; i < arguments.size(); i++)
  {
    ...
    else if(i < parameter_types.size())
    {
      ...
      if(
        op_type.id() == ID_bool && op.id() == ID_side_effect &&
...
void c_typecheck_baset::typecheck_expr_shifts(shift_exprt &expr)
{
  ...
  if(
    o_type0.id() == ID_vector && is_number(follow(o_type0.subtype())) &&
    is_number(o_type1))
  {
...
void c_typecheck_baset::typecheck_expr_pointer_arithmetic(exprt &expr)
{
    ...
    (expr.id() == ID_side_effect && expr.get(ID_statement) == ID_assign_plus))
  {
    ...
    if(
      int_op_type.id() == ID_bool || int_op_type.id() == ID_c_bool ||
      int_op_type.id() == ID_unsignedbv || int_op_type.id() == ID_signedbv ||
      int_op_type.id() == ID_c_bit_field || int_op_type.id() == ID_c_enum_tag)
    {
  ...
  side_effect_exprt &expr)
{
    ...
    statement == ID_assign_bitor)
  {
    ...
    if(o_type0.id() == ID_bool || o_type0.id() == ID_c_bool)
    {
      ...
      o_type0.id() == ID_c_enum_tag || o_type0.id() == ID_unsignedbv ||
