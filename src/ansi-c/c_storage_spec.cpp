...
void c_storage_spect::read(const typet &type) {
  if (type.id() == ID_merged_type || type.id() == ID_code) {
    forall_subtypes(it, type) read(*it);
