...
///
/// \returns Returns a reference to the new symbol
...
///   lifetime
///
/// \returns Returns the address of the allocated symbol
...
///
/// \returns Returns the symbol_exprt for the symbol created
