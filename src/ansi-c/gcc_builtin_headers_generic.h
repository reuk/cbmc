...
void *__builtin___memcpy_chk(void *dest, const void *src, __CPROVER_size_t n,
                             __CPROVER_size_t size);
char *__builtin___memmove_chk(void *dest, const void *src, __CPROVER_size_t n,
                              __CPROVER_size_t size);
...
int __builtin_vsnprintf(char *restrict str, __CPROVER_size_t size,
                        const char *restrict format, __builtin_va_list ap);
long __builtin_expect(long, long);
void *__builtin_memset(void *s, int c, __CPROVER_size_t n);
void *__builtin___memset_chk(void *s, int c, __CPROVER_size_t n,
                             __CPROVER_size_t size);
...
void *__builtin___mempcpy_chk(void *dest, const void *src, __CPROVER_size_t n,
                              __CPROVER_size_t size);
char *__builtin_strcat(char *dest, const char *src);
char *__builtin___strcat_chk(char *dest, const char *src,
                             __CPROVER_size_t size);
...
char *__builtin___strncpy_chk(char *dest, const char *src, __CPROVER_size_t n,
                              __CPROVER_size_t size);
char *__builtin_stpcpy(char *dest, const char *src);
char *__builtin___stpcpy(char *s1, const char *s2);
char *__builtin___stpncpy_chk(char *s1, const char *s2, __CPROVER_size_t n,
                              __CPROVER_size_t size);
int __builtin___sprintf_chk(char *s, int flag, __CPROVER_size_t os,
                            const char *fmt, ...);
int __builtin___snprintf_chk(char *s, __CPROVER_size_t maxlen, int flag,
                             __CPROVER_size_t os, const char *fmt, ...);
int __builtin___vsprintf_chk(char *s, int flag, __CPROVER_size_t os,
                             const char *fmt, __builtin_va_list ap);
int __builtin___vsnprintf_chk(char *s, __CPROVER_size_t maxlen, int flag,
                              __CPROVER_size_t os, const char *fmt,
...
char *__builtin___strncat_chk(char *dest, const char *src, __CPROVER_size_t n,
                              __CPROVER_size_t size);
char *__builtin___stpcpy_chk(char *dest, const char *src,
                             __CPROVER_size_t size);
