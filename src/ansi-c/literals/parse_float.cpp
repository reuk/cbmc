...
void parse_float(const std::string &src, mp_integer &significand,
                 mp_integer &exponent, unsigned &exponent_base, bool &is_float,
                 bool &is_long, bool &is_imaginary, bool &is_decimal,
                 bool &is_float80, bool &is_float128) {
  ...
  // get flags
  is_float = is_long = is_imaginary = is_decimal = is_float80 = is_float128 =
      false;
