...
__gcc_v16qi
__builtin_ia32_pcmpestrm128(__gcc_v16qi, int, __gcc_v16qi, int, const int);
...
unsigned long long
__builtin_ia32_crc32di(unsigned long long, unsigned long long);
...
__gcc_v4df
__builtin_ia32_vpermil2pd256(__gcc_v4df, __gcc_v4df, __gcc_v4di, int);
__gcc_v4sf __builtin_ia32_vpermil2ps(__gcc_v4sf, __gcc_v4sf, __gcc_v4si, int);
__gcc_v8sf
__builtin_ia32_vpermil2ps256(__gcc_v8sf, __gcc_v8sf, __gcc_v8si, int);
...
__gcc_v2df __builtin_ia32_gathersi__gcc_v2df(
  __gcc_v2df,
  const double *,
  __gcc_v4si,
  __gcc_v2df,
  int);
__gcc_v4df __builtin_ia32_gathersi__gcc_v4df(
  __gcc_v4df,
  const double *,
  __gcc_v4si,
  __gcc_v4df,
  int);
__gcc_v2df __builtin_ia32_gatherdi__gcc_v2df(
  __gcc_v2df,
  const double *,
  __gcc_v2di,
  __gcc_v2df,
  int);
__gcc_v4df __builtin_ia32_gatherdi__gcc_v4df(
  __gcc_v4df,
  const double *,
  __gcc_v4di,
  __gcc_v4df,
  int);
__gcc_v4sf __builtin_ia32_gathersi__gcc_v4sf(
  __gcc_v4sf,
  const float *,
  __gcc_v4si,
  __gcc_v4sf,
  int);
__gcc_v8sf __builtin_ia32_gathersi__gcc_v8sf(
  __gcc_v8sf,
  const float *,
  __gcc_v8si,
  __gcc_v8sf,
  int);
__gcc_v4sf __builtin_ia32_gatherdi__gcc_v4sf(
  __gcc_v4sf,
  const float *,
  __gcc_v2di,
  __gcc_v4sf,
  int);
__gcc_v4sf __builtin_ia32_gatherdi__gcc_v4sf256(
  __gcc_v4sf,
  const float *,
  __gcc_v4di,
  __gcc_v4sf,
  int);
__gcc_v2di __builtin_ia32_gathersi__gcc_v2di(
  __gcc_v2di,
  const long long int *,
  __gcc_v4si,
  __gcc_v2di,
  int);
__gcc_v4di __builtin_ia32_gathersi__gcc_v4di(
  __gcc_v4di,
  const long long int *,
  __gcc_v4si,
  __gcc_v4di,
  int);
__gcc_v2di __builtin_ia32_gatherdi__gcc_v2di(
  __gcc_v2di,
  const long long int *,
  __gcc_v2di,
  __gcc_v2di,
  int);
__gcc_v4di __builtin_ia32_gatherdi__gcc_v4di(
  __gcc_v4di,
  const long long int *,
  __gcc_v4di,
  __gcc_v4di,
  int);
__gcc_v4si __builtin_ia32_gathersi__gcc_v4si(
  __gcc_v4si,
  const int *,
  __gcc_v4si,
  __gcc_v4si,
  int);
__gcc_v8si __builtin_ia32_gathersi__gcc_v8si(
  __gcc_v8si,
  const int *,
  __gcc_v8si,
  __gcc_v8si,
  int);
__gcc_v4si __builtin_ia32_gatherdi__gcc_v4si(
  __gcc_v4si,
  const int *,
  __gcc_v2di,
  __gcc_v4si,
  int);
__gcc_v4si __builtin_ia32_gatherdi__gcc_v4si256(
  __gcc_v4si,
  const int *,
  __gcc_v4di,
  __gcc_v4si,
...
__gcc_v2di
__builtin_ia32_extrqi(__gcc_v2di, const unsigned int, const unsigned int);
__gcc_v2di __builtin_ia32_insertq(__gcc_v2di, __gcc_v2di);
__gcc_v2di __builtin_ia32_insertqi(
  __gcc_v2di,
  __gcc_v2di,
  const unsigned int,
  const unsigned int);
...
__gcc_v16hi
  __builtin_ia32_vpcmov_v16hi256(__gcc_v16hi, __gcc_v16hi, __gcc_v16hi);
__gcc_v32qi
  __builtin_ia32_vpcmov_v32qi256(__gcc_v32qi, __gcc_v32qi, __gcc_v32qi);
__gcc_v4df
  __builtin_ia32_vpcmov___gcc_v4df256(__gcc_v4df, __gcc_v4df, __gcc_v4df);
__gcc_v8sf
  __builtin_ia32_vpcmov___gcc_v8sf256(__gcc_v8sf, __gcc_v8sf, __gcc_v8sf);
...
unsigned char
__builtin_ia32_lwpins16(unsigned short, unsigned int, unsigned short);
unsigned char __builtin_ia32_lwpins32(unsigned int, unsigned int, unsigned int);
unsigned char
__builtin_ia32_lwpins64(unsigned __int64, unsigned int, unsigned int);
unsigned int __builtin_ia32_bextr_u32(unsigned int, unsigned int);
unsigned long long
__builtin_ia32_bextr_u64(unsigned long long, unsigned long long);
...
unsigned long long
__builtin_ia32_bextri_u64(unsigned long long, const unsigned long long);
