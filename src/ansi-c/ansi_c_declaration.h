...
public:
  ...
  irep_idt get_name() const { return get(ID_name); }
...
public:
  ...
  bool get_is_typedef() const { return get_bool(ID_is_typedef); }

  void set_is_typedef(bool is_typedef) { set(ID_is_typedef, is_typedef); }

  bool get_is_enum_constant() const { return get_bool(ID_is_enum_constant); }

  void set_is_enum_constant(bool is_enum_constant) {
    set(ID_is_enum_constant, is_enum_constant);
  }

  bool get_is_static() const { return get_bool(ID_is_static); }

  void set_is_static(bool is_static) { set(ID_is_static, is_static); }

  bool get_is_parameter() const { return get_bool(ID_is_parameter); }

  void set_is_parameter(bool is_parameter) {
    set(ID_is_parameter, is_parameter);
  }

  bool get_is_member() const { return get_bool(ID_is_member); }

  void set_is_member(bool is_member) { set(ID_is_member, is_member); }

  bool get_is_global() const { return get_bool(ID_is_global); }

  void set_is_global(bool is_global) { set(ID_is_global, is_global); }

  bool get_is_register() const { return get_bool(ID_is_register); }

  void set_is_register(bool is_register) { set(ID_is_register, is_register); }

  bool get_is_thread_local() const { return get_bool(ID_is_thread_local); }

  void set_is_thread_local(bool is_thread_local) {
    set(ID_is_thread_local, is_thread_local);
  }

  bool get_is_inline() const { return get_bool(ID_is_inline); }

  void set_is_inline(bool is_inline) { set(ID_is_inline, is_inline); }

  bool get_is_extern() const { return get_bool(ID_is_extern); }

  void set_is_extern(bool is_extern) { set(ID_is_extern, is_extern); }

  bool get_is_static_assert() const { return get_bool(ID_is_static_assert); }

  void set_is_static_assert(bool is_static_assert) {
    set(ID_is_static_assert, is_static_assert);
  }

  bool get_is_weak() const { return get_bool(ID_is_weak); }

  void set_is_weak(bool is_weak) { set(ID_is_weak, is_weak); }
  ...
  declaratorst &declarators() { return (declaratorst &)operands(); }
