...
void interrupt(value_setst &value_sets, const symbol_tablet &symbol_table,
#ifdef LOCAL_MAY
...
symbol_exprt get_isr(const symbol_tablet &symbol_table,
  ...
  forall_symbol_base_map(m_it, symbol_table.symbol_base_map,
                         interrupt_handler) {
    // look it up
...
void interrupt(value_setst &value_sets, const symbol_tablet &symbol_table,
  ...
  rw_set_functiont isr_rw_set(value_sets, ns, goto_functions, isr);
  ...
  Forall_goto_functions(
      ...
      interrupt(value_sets, symbol_table,
#ifdef LOCAL_MAY
                f_it->second,
#endif
