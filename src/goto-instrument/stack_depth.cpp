...
void stack_depth(goto_programt &goto_program, const symbol_exprt &symbol,
                 const int i_depth, const exprt &max_depth) {
  ...
  assert_ins->source_location.set_comment("Stack depth exceeds " +
...
void stack_depth(symbol_tablet &symbol_table, goto_functionst &goto_functions,
  ...
  Forall_goto_functions(
      f_it, goto_functions) if (f_it->second.body_available() &&
