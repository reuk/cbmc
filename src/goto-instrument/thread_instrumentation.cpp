...
void thread_exit_instrumentation(goto_programt &goto_program) {
  ...
  exprt mutex_locked_string = string_constantt("mutex-locked");
...
void mutex_init_instrumentation(const symbol_tablet &symbol_table,
                                goto_programt &goto_program, typet lock_type) {
...
void mutex_init_instrumentation(const symbol_tablet &symbol_table,
  ...
  Forall_goto_functions(f_it, goto_functions) mutex_init_instrumentation(
