...
public:
  ...
  abstract_eventt(operationt _op, unsigned _th, irep_idt _var, unsigned _id,
                  source_locationt _loc, bool _local)
      : operation(_op), thread(_th), variable(_var), id(_id),
        source_location(_loc), local(_local) {}

  abstract_eventt(operationt _op, unsigned _th, irep_idt _var, unsigned _id,
                  source_locationt _loc, bool _local, bool WRf, bool WWf,
                  bool RRf, bool RWf, bool WWc, bool RWc, bool RRc)
      : operation(_op), thread(_th), variable(_var), id(_id),
        source_location(_loc), local(_local), WRfence(RWf), WWfence(WWf),
        RRfence(RRf), RWfence(WRf), WWcumul(WWc), RWcumul(RWc), RRcumul(RRc) {}
  ...
  bool operator<(const abstract_eventt &other) const { return (id < other.id); }
  ...
  bool unsafe_pair_asm(const abstract_eventt &next, memory_modelt model,
