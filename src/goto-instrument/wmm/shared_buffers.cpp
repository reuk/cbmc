...
operator()(const irep_idt &object)
{
  ...
  vars.read_delayed_var= add(
    object, symbol.base_name, "$read_delayed_var", pointer_typet(symbol.type));
...
/* trick using an additional variable whose value is to be defined later */
  ...
  assignment(
    goto_program, target, source_location, vars.read_delayed, true_exprt());
  assignment(
    goto_program,
    target,
    source_location,
  ...
  const unsigned current_thread)
{
  ...
  assignment(
    ...
    vars.w_buff0_used);
  assignment(
    goto_program, target, source_location, vars.w_buff0_used, true_exprt());
  ...
  const unsigned current_thread)
{
  ...
  assignment(
    ...
    vars.w_buff1_used,
    if_exprt(
      buff0_or_buff1_used_and_mine_expr, false_exprt(), buff1_used_expr));
  ...
  assignment(
    ...
    if_exprt(buff0_or_buff1_used_and_mine_expr, false_exprt(), buff1_thd_expr));
}
  ...
  const bool tso_pso_rmo) // true: tso/pso/rmo; false: power
{
  ...
  try
  {
    ...
    // throw Boolean dice
    assignment(
      goto_program, target, source_location, choice0, nondet_bool_expr);
    assignment(
      goto_program, target, source_location, choice2, nondet_bool_expr);
      ...
      assignment(
        ...
        if_exprt(
          ...
          if_exprt(
            cond_134_expr,
            buff0_134_expr,
            if_exprt(cond_267_expr, buff0_267_expr, buff0_5_expr))));
      // buff1
      assignment(
        goto_program,
        target,
        ...
        if_exprt(
          ...
          if_exprt(
            cond_134_expr,
            buff1_134_expr,
            if_exprt(cond_267_expr, buff1_267_expr, buff1_5_expr))));
      // buff0_used
      assignment(
        goto_program,
        target,
        ...
        if_exprt(
          ...
          if_exprt(
            cond_134_expr,
            buff0_used_134_expr,
            if_exprt(cond_267_expr, buff0_used_267_expr, buff0_used_5_expr))));
      // buff1_used
      assignment(
        goto_program,
        target,
        ...
        if_exprt(
          ...
          if_exprt(
            cond_134_expr,
            buff1_used_134_expr,
            if_exprt(cond_267_expr, buff1_used_267_expr, buff1_used_5_expr))));
      // buff0_thd
      assignment(
        goto_program,
        target,
        ...
        if_exprt(
          ...
          if_exprt(
            cond_134_expr,
            buff0_thd_134_expr,
            if_exprt(cond_267_expr, buff0_thd_267_expr, buff0_thd_5_expr))));
      // buff1_thd
      assignment(
        goto_program,
        target,
        ...
        if_exprt(
          ...
          if_exprt(
            cond_134_expr,
            buff1_thd_134_expr,
            if_exprt(cond_267_expr, buff1_thd_267_expr, buff1_thd_5_expr))));
    }
    // POWER
    else
    {
        ...
        if_exprt(
          ...
          if_exprt(
            ...
            if_exprt(
              cond_4_expr,
              val_4_expr,
              if_exprt(cond_5_expr, val_5_expr, val_3_expr)))));
      // buff0
      assignment(
        goto_program,
        target,
          ...
          if_exprt(
            ...
            if_exprt(
              ...
              if_exprt(
                cond_4_expr,
                buff0_4_expr,
                if_exprt(cond_5_expr, buff0_5_expr, buff0_3_expr))))));
      // buff1
      assignment(
        goto_program,
        target,
          ...
          if_exprt(
            ...
            if_exprt(
              ...
              if_exprt(
                ...
                buff0_used_4_expr,
                if_exprt(
                  cond_5_expr, buff0_used_5_expr, buff0_used_3_expr))))));
      // buff1_used
      assignment(
        goto_program,
        target,
          ...
          if_exprt(
            ...
            if_exprt(
              ...
              if_exprt(
                ...
                buff1_used_4_expr,
                if_exprt(
                  cond_5_expr, buff1_used_5_expr, buff1_used_3_expr))))));
      // buff0_thd
      assignment(
        goto_program,
        target,
          ...
          if_exprt(
            ...
            if_exprt(
              ...
              if_exprt(
                cond_4_expr,
                buff0_thd_4_expr,
                if_exprt(cond_5_expr, buff0_thd_5_expr, buff0_thd_3_expr))))));
      // buff1_thd
      assignment(
        goto_program,
        target,
          ...
          if_exprt(
            ...
            if_exprt(
              ...
              if_exprt(
                cond_4_expr,
                buff1_thd_4_expr,
                if_exprt(cond_5_expr, buff1_thd_5_expr, buff1_thd_3_expr))))));
    }
  }
  catch(std::string s)
  {
        ...
        instruction.code.get_bool("RRfence"))))
    {
          ...
          s_it++)
      {
        shared_buffers.det_flush(
          goto_program, i_it, source_location, *s_it, current_thread);
      }
