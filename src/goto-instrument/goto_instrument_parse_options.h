...
#define GOTO_INSTRUMENT_OPTIONS                                                   \
  ...
  "(dump-c)(dump-cpp)(use-system-headers)(dot)(xml)" OPT_GOTO_CHECK /* no-X-check \
                                                                       are        \
                                                                       deprecated \
                                                                       and        \
                                                                       ignored    \
  ...
  "(function-enter):(function-exit):(branch):" OPT_SHOW_GOTO_FUNCTIONS            \
  ...
  "(inline)(partial-inline)(function-inline):(log):(no-"                          \
  "caching)" OPT_REMOVE_CONST_FUNCTION_POINTERS "(remove-function-pointers)"      \
...
public:
  ...
  goto_instrument_parse_optionst(int argc, const char **argv)
      : parse_options_baset(GOTO_INSTRUMENT_OPTIONS, argc, argv),
        ...
        function_pointer_removal_done(false), partial_inlining_done(false),
