...
class acceleratet {
public:
  acceleratet(goto_programt &_program, goto_functionst &_goto_functions,
              symbol_tablet &_symbol_table, bool _use_z3)
      : program(_program), goto_functions(_goto_functions),
        symbol_table(_symbol_table), ns(symbol_table),
        utils(symbol_table, goto_functions), use_z3(_use_z3) {
...
protected:
  void find_paths(goto_programt::targett &loop_header, pathst &loop_paths,
                  pathst &exit_paths, goto_programt::targett &back_jump);

  void extend_path(goto_programt::targett &t,
                   goto_programt::targett &loop_header,
                   natural_loops_mutablet::natural_loopt &loop, patht &prefix,
                   pathst &loop_paths, pathst &exit_paths,
  ...
  void insert_looping_path(goto_programt::targett &loop_header,
                           goto_programt::targett &back_jump,
                           goto_programt &looping_path, patht &inserted_path);
  ...
  void build_state_machine(trace_automatont::sym_mapt::iterator p,
                           ...
                           state_sett &accept_states, symbol_exprt state,
...
void accelerate_functions(goto_functionst &functions, symbol_tablet &ns,
                          bool use_z3);
