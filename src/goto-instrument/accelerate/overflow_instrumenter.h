...
public:
  overflow_instrumentert(goto_programt &_program, const exprt &_overflow_var,
                         symbol_tablet &_symbol_table)
      : program(_program), symbol_table(_symbol_table),
        overflow_var(_overflow_var), ns(symbol_table) {}
