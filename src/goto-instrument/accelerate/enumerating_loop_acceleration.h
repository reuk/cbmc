...
public:
  enumerating_loop_accelerationt(symbol_tablet &_symbol_table,
      ...
      : symbol_table(_symbol_table), goto_functions(_goto_functions),
        goto_program(_goto_program), loop(_loop), loop_header(_loop_header),
  ...
  ~enumerating_loop_accelerationt() { delete path_enumerator; }
