...
/// This nested method iteratively applies ''collect_mcdc_controlling'' to
/// every non-atomic expr within a decision
...
///
/// \returns +1 : not negated -1 : negated
...
/// atomic expr ''c''. A mcdc pair of (e1, e2) regarding ''c'' means that
/// ''e1'' and ''e2'' result in different ''decision'' values, and this is
...
/// minimum is in a sense that by deleting any controlling condition in the
/// set, the mcdc coverage for the decision will be not complete.
///
