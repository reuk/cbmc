...
public:
  ...
  virtual void
  dependencies(const std::string &module, std::set<std::string> &modules);
  ...
  virtual bool
  typecheck(symbol_tablet &symbol_table, const std::string &module)= 0;
  ...
  virtual bool
  type_to_name(const typet &type, std::string &name, const namespacet &ns);
