...
public:
  ...
  virtual bool preprocess(std::istream &instream, const std::string &path,
  ...
  virtual void dependencies(const std::string &module,
  ...
  virtual bool typecheck(symbol_tablet &symbol_table,
  ...
  virtual bool type_to_name(const typet &type, std::string &name,
                            const namespacet &ns);

  virtual bool to_expr(const std::string &code, const std::string &module,
                       exprt &expr, const namespacet &ns) = 0;
