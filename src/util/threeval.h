...
public:
  ...
  static inline tvt unknown() { return tvt(tv_enumt::TV_UNKNOWN); }

  const char *to_string() const;

  tv_enumt get_value() const { return value; }
  ...
  bool operator==(const tvt other) const { return value == other.value; }
