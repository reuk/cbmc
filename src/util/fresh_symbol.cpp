...
///
/// parameters: `type`: type of new symbol `name_prefix`, `basename_prefix`:
///   new symbol will be named name_prefix::basename_prefix$num unless
///   name_prefix is empty, in which case the :: prefix is omitted.
///   `source_location`: new symbol source loc `symbol_mode`: new symbol mode
