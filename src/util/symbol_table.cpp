...
///
/// \returns Returns a boolean indicating whether the process failed, which
...
/// same name then symbol is unchanged, new_symbol points to the symbol with
/// the same name and true is returned. Otherwise, the symbol is moved into the
...
///
/// \returns Returns a boolean indicating whether the process failed
...
///
/// \returns The symbol in the symbol table with the correct name
