...
/// Note that calling from_double -> to_double can return different bit
/// patterns for NaN.
...
/// Sets *this to the next representable number closer to plus infinity
/// (greater = true) or minus infinity (greater = false).
