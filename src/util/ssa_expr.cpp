...
static void build_ssa_identifier_rec(const exprt &expr, const irep_idt &l0,
                                     const irep_idt &l1, const irep_idt &l2,
                                     std::ostream &os,
...
std::pair<irep_idt, irep_idt> ssa_exprt::build_identifier(const exprt &expr,
                                                          const irep_idt &l0,
                                                          const irep_idt &l1,
                                                          const irep_idt &l2) {
