...
template <int> std::size_t basic_hash_combine(std::size_t h1, std::size_t h2);
...
template <>
inline std::size_t murmurhash2a_hash_combine<32>(std::size_t h1,
                                                 std::size_t h2) {
  return mmix32(h1, h2);
}
...
template <>
inline std::size_t murmurhash2a_hash_finalize<32>(std::size_t h1,
                                                  std::size_t len) {
  const uint32_t m = 0x5bd1e995;
...
template <>
inline std::size_t murmurhash2a_hash_combine<64>(std::size_t h1,
                                                 std::size_t h2) {
  return mmix64(h1, h2);
}
...
template <>
inline std::size_t murmurhash2a_hash_finalize<64>(std::size_t h1,
                                                  std::size_t len) {
  const int r = 47;
  const uint64_t m = 0xc6a4a7935bd1e995;
...
template <>
inline std::size_t murmurhash3_hash_combine<32>(std::size_t h1,
                                                std::size_t h2) {
...
template <>
inline std::size_t murmurhash3_hash_finalize<32>(std::size_t h1,
                                                 std::size_t len) {
  h1 ^= len;
...
template <>
inline std::size_t murmurhash3_hash_combine<64>(std::size_t h1,
                                                std::size_t h2) {
...
template <>
inline std::size_t murmurhash3_hash_finalize<64>(std::size_t h1,
                                                 std::size_t len) {
  h1 ^= len;
