...
public:
  ...
  bool operator==(const char *b) const { return strcasecmp(c_str(), b) == 0; }
...
public:
  ...
  bool is_nil() const { return type == Symbol && value == "nil"; }
...
inline std::ostream &operator<<(std::ostream &out, const lispexprt &expr) {
