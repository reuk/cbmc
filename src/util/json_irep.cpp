...
///
/// \param include_comments: when writing JSON, should the comments sub tree be
///   included.
...
/// The parent JSON object will get a key called sub_tree_id and the value
/// shall be an array of JSON objects generated from each of the sub trees
///
...
///
/// \returns result - irep equivalent of input
