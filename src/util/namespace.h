...
public:
  ...
  explicit namespacet(const symbol_tablet &_symbol_table) {
    symbol_table1 = &_symbol_table;
    symbol_table2 = NULL;
  }

  namespacet(const symbol_tablet &_symbol_table1,
  ...
  const symbol_tablet &get_symbol_table() const { return *symbol_table1; }
...
public:
  ...
  explicit multi_namespacet(const symbol_tablet &symbol_table)
      : namespacet(NULL, NULL) {
    add(symbol_table);
  }
